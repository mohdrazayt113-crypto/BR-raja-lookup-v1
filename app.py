...
def get_account_credentials(region: str) -> str:
    r = region.upper()
    if r == "IND":
        return "uid=4464512612&password=624559D429F6632E6BF0C9620A945FB3C5F214246741CA3FF9FAEF3069B5E65E"
    elif r == "ME":
        return "uid=4751672491&password=RAJA_BYSTARGMR_I0QisKOz"
    elif r in {"BR", "US", "SAC", "NA"}:
        return "uid=4751672508&password=RAJA_BYSTARGMR_6gyiphzm"
    else:
        return "uid=4695587310&password=4043395F636D32DF9C0400ADD38BC8DAE2E0D297C027D51D7B52F9530D3F65A9"
